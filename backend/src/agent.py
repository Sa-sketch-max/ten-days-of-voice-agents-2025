...
# 👨‍⚕️ "Sahil's AI Store" - Auto-Lead Capture Agent
...
print("📚 SELLING: Sahil's Cloud & AI Courses")
...
# Default FAQ data for "Sahil's AI Store"
DEFAULT_FAQ = [
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Sahil's AI Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Sahil and email you." (Don't hallucinate prices).
            """,
